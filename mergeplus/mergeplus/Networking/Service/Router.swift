...
class Router<Endpoint: EndPointType>: NetworkRouter {
  ...
  fileprivate func buildRequest(from route: Endpoint) throws -> URLRequest {
    ...
    request.setValue("User-Agent", forHTTPHeaderField: "mirge")
    request.setValue("Os", forHTTPHeaderField: "IOS")
    request.setValue("Version", forHTTPHeaderField: Bundle.main.versionNumber)
